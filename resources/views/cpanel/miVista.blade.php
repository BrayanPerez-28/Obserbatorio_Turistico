...
<head>
    ...
    <!-- Tus estilos -->
    <link rel="stylesheet" href="{{ asset(path: 'css/base.css') }}" />
    <link rel="stylesheet" href="{{ asset(path: 'css/estilo_graficos_indicadores.css') }}" />
</head>
...
<body>
    <nav class="navbar custom-navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand" href="#">
                <img src="{{ asset(path: 'image/huaquechulaLogo.png') }}" alt="Logo" style="height: 70px; width: auto;">
            </a>
            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        ...
                        <ul class="submenu">
                            <li><a class="nav-link submenu-item" href="login.html">Iniciar sesión</a></li>
                            <li><a class="nav-link submenu-item" href="registro.html">Encuesta</a></li>
                        </ul>
                        <li class="nav-item"><a class="nav-link" href="repositorio.html">Repositorio</a></li>
                    </ul>
                </div>
            </div>
    ...
    <!-- Tus scripts -->
    <script src="{{ asset(path: 'js/java.js') }}"></script>
    <script src="{{ asset(path: 'js/script_graficos_indicadores.js') }}"></script>
</body>
